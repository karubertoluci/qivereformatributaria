                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 shadow-lg mb-10">
                  <Tabs defaultValue="cnae" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 mb-6">
                      <TabsTrigger value="cnae">Buscar por CNAE</TabsTrigger>
                      <TabsTrigger value="segment">Navegar por Segmento</TabsTrigger>
                    </TabsList>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {businessSegments.slice(0, 6).map((segment) => (
                          <Button 
                            key={segment.id}
                            variant="outline" 
                            className="bg-white/80 text-primary hover:bg-white flex flex-col h-auto py-3"
