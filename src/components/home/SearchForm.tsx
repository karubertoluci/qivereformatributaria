...
const SearchForm: React.FC<SearchFormProps> = ({ onCnaeSubmit, onBrowseBySegment, onSelectSegment }) => {
  ...
  // Simular o carregamento do relatório
  ...
  const handleSubmit = (data: FormValues) => {
    ...
    // Salvamos os dados do formulário no localStorage
    localStorage.setItem('formData', JSON.stringify(data));
    
    // Simulamos um delay para parecer que estamos processando
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <div className="bg-orange-50 rounded-lg shadow-md p-6 mb-8">
      <h2 className="text-2xl font-bold text-center mb-2">Relatório personalizado da reforma tributária para sua empresa</h2>
      <p className="text-orange-600 text-center mb-6">
        Descubra como a reforma tributária impacta diretamente o seu negócio com nossa análise personalizada.
      </p>
      ...
      {!showFullForm ? (
        <div className="flex flex-col items-center">
          <Button 
            ...
            className="bg-orange-500 hover:bg-orange-600 transition-colors text-lg py-6 px-8 mb-4"
            size="lg"
          >
