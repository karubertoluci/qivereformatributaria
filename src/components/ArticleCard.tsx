...
import { ArrowDown, ArrowUp, BookOpen, Info, Lightbulb } from 'lucide-react';
        ...
        {expanded && (
          <div className="border-t border-gray-200 pt-4 mt-4">
            <div className="mb-4">
              ...
              <p className="text-sm">{article.simplifiedText}</p>
            </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-500 italic">{article.originalText}</p>
            </div>
            
            <div>
              <h4 className="text-sm font-bold mb-2">Impactos para seu Segmento</h4>
                ...
                {segmentImpacts.map((impact, index) => (
                  ...
                  >
                    <div className="flex items-center">
                      {impact.type === 'positive' && <ArrowUp className="h-4 w-4 mr-2" />}
                      {impact.type === 'negative' && <ArrowDown className="h-4 w-4 mr-2" />}
                      {impact.type === 'neutral' && <Info className="h-4 w-4 mr-2" />}
                      {impact.description}
                    </div>
                  </li>
                ))}
